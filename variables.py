...
TENSORFLOW_MODEL_PATH = DEFAULT_LOCATION + SYSTEM_SEP + SUPPORT_FOLDER + SYSTEM_SEP + "tensorflow_model"
TENSORFLOW_MODEL_PATH_LOAD = TENSORFLOW_MODEL_PATH + ".ckpt"
TENSORFLOW_MODEL_PATH_LOAD_REG = TENSORFLOW_MODEL_PATH + "_reg.ckpt"
ENSEMBLE_ML_MODEL = DEFAULT_LOCATION + SYSTEM_SEP + SUPPORT_FOLDER + SYSTEM_SEP + "ensemble_model.pkl"
...
Numerical variables
"""
NEIGHBORS_THRESHOLD_LIST = [2, 3, 5, 8, 15, 30]
RANDOM_SEED = 42
CLASS_VALUES= [0,1]
#LAYER_COMP = [25,25,25,25,25]
LAYER_COMP = [150,150,150,150,150]
#INPUT_LAYER = 1157
INPUT_LAYER = 1352
NUMBER_CLASSES = 2
